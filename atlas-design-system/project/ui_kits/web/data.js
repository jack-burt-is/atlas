...
(function () {
  ...
  const achievements = [
    { id: 'skyliner', title: 'Skyliner', desc: 'Climb three 800m summits in one day', tier: 'gold', points: 500, unlocked: true, icon: 'mountain', cat: 'Summits', rarity: 6.2, date: 'Apr 2026' },
    { id: 'first-k', title: 'Into Thin Air', desc: 'Reach your first 1000m summit', tier: 'silver', points: 250, unlocked: true, icon: 'flag', cat: 'Summits', rarity: 41.0, date: 'Jun 2023' },
    { id: 'trail-done', title: 'End to End', desc: 'Complete a National Trail', tier: 'gold', points: 500, unlocked: true, icon: 'route', cat: 'Trails', rarity: 8.7, date: 'Sep 2025' },
    { id: 'fifty-k', title: 'The Long Way', desc: 'Hike 50km in a single day', tier: 'platinum', points: 750, unlocked: true, icon: 'footprints', cat: 'Endurance', rarity: 1.4, date: 'Aug 2025' },
    { id: 'early-riser', title: 'Dawn Patrol', desc: 'Log five sunrise summits', tier: 'silver', points: 250, unlocked: true, icon: 'sunrise', cat: 'Summits', rarity: 19.3, date: 'Jul 2024' },
    { id: 'cartographer', title: 'Cartographer', desc: 'Visit 25 trig pillars', tier: 'bronze', points: 100, unlocked: true, icon: 'triangle', cat: 'Landmarks', rarity: 33.5, date: 'Feb 2024' },
    { id: 'centurion', title: 'Centurion', desc: 'Visit 100 unique summits', tier: 'silver', points: 250, unlocked: false, icon: 'mountain', cat: 'Summits', progress: { value: 78, max: 100 }, rarity: 14.8 },
    { id: 'region-90', title: 'Local Legend', desc: 'Explore 90% of a single region', tier: 'gold', points: 500, unlocked: false, icon: 'compass', cat: 'Coverage', progress: { value: 68, max: 90 }, rarity: 5.1 },
    { id: 'all-weather', title: 'All Weather', desc: 'Summit in snow, rain and sun', tier: 'bronze', points: 100, unlocked: false, icon: 'cloud-rain', cat: 'Summits', progress: { value: 2, max: 3 }, rarity: 22.0 },
    { id: 'collector', title: 'Completionist', desc: 'Finish an entire collection', tier: 'platinum', points: 750, unlocked: false, icon: 'award', cat: 'Coverage', progress: { value: 1, max: 3 }, rarity: 2.3 },
    { id: 'nightfall', title: 'Nightfall', desc: 'Complete a walk after dark', tier: 'bronze', points: 100, unlocked: false, icon: 'moon', cat: 'Endurance', progress: null, rarity: 28.9 },
    { id: 'globetrotter', title: 'Globetrotter', desc: 'Summit peaks in five countries', tier: 'gold', points: 500, unlocked: false, icon: 'globe', cat: 'Coverage', progress: { value: 4, max: 5 }, rarity: 3.6 },
  ];

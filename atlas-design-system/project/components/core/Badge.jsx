...
export function Badge({ variant = 'neutral', dot = false, icon = null, className = '', children, ...rest }) {
  ensure();
  return (
    <span className={['atlas-badge', `atlas-badge--${variant}`, className].filter(Boolean).join(' ')} {...rest}>
